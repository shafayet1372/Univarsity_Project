...
Route::get('/users/{id}/{name}','UserController@index')->name('user.show');
Route::get('user/profile',"UserController@profile")->name('user.profile');
Route::post('user/profile/create','UserController@store')->name('profile.create');
Route::post('user/avatar','UserController@avatar')->name('avatar');
Route::view('sharer/register','auth.sharer-register')->name('sharer.register');
Route::get('/user/{id}/{name}/{count}','UserController@user_another')->name('user.another');
//Route::post('sharer/register','SharerRegisterController@sharerRegister')->name('sharer.register');
...
Route::get('/jobs/edit/{slug}/{id}','JobController@edit')->name('job.edit');
...
Route::post('/jobs/mails','offerEmailController@sends')->name('offermail');
